...
export const labEditorTheme = EditorView.theme(
  {
    ...
    ".cm-panels-bottom": {
      ...
      borderTop: "1px solid #304041",
      display: "flex",
      justifyContent: "flex-end",
    },
    ".cm-vim-toggle-panel": {
      alignItems: "stretch",
      borderLeft: "1px solid #304041",
      display: "flex",
      flex: "0 0 auto",
      fontFamily: "'DM Mono', monospace",
      fontSize: "12px",
    ...
    ".cm-vim-toggle-panel button:hover": { color: "#d8ff57" },
    ".cm-vim-toggle-panel button[aria-pressed=\"true\"]": { color: "#d8ff57" },
  },
  { dark: true },
)
